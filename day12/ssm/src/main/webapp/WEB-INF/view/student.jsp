        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="ssid" id = "txt_search_roleid">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学校：</td>
								<td>
									<select class="form-control" name="ssid" id = "ssid" aria-required="true" required/>
										<option value="0">---请选择---</option>
										<c:forEach items="${slist }" var="s">
										 	<option value="${s.ssid }">${s.ssname }</option>
										</c:forEach>
	    		...
	    		var myEcharts = echarts.init(document.getElementById("main"));
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
	    			    	//循环集合
	    			    	res.vlist.forEach(function(student){
	    			    		xdata.push(student.ssname);
	    			    		ydata.push({value:student.num,name:student.ssname});
	    			    	})
/* 	    			    	option = {
			    			    xAxis: {
			    			        type: 'category',
